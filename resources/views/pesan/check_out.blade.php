                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ url('check-out') }}/{{ $item->id }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <button type="submit" class="btn btn-danger" onclick="confirm('Apakah anda yakin ingin menghapus pesanan ini?')"><i class="fa fa-trash"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
                                <tr>
                                    ...
                                    <td><a href="{{ url('konfirmasi-check-out') }}" class="btn btn-success" onclick="check_out()" ><i class="fa fa-shopping-cart"></i> Check Out</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<script>
    function check_out(){
        confirm("Apakah anda yakin ingin check out?");
    }
</script>
@endsection
